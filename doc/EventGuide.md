...
|----------|-----------------------------------------|-----------|
| Register | `RegisterEvent(event) Use EventService` | Server    |
...
| Action   | Method                                        | Call From  |
|----------|-----------------------------------------------|------------|
| Register | `RegisterClientEvent(event) Use EventService` | Server     |
...
| Action   | Method                                     | Call From |
|----------|--------------------------------------------|-----------|
| Register | `RegisterEvent(event) Use EventController` | Client    |
