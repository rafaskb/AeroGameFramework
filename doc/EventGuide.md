...
|----------|--------------------------------------|---------------------------|
| Register | `RegisterEvent(event)`               | Server **(EventService)** |
...
| Action   | Method                                      | Call From                 |
|----------|---------------------------------------------|---------------------------|
| Register | `RegisterClientEvent(event)`                | Server **(EventService)** |
...
| Action   | Method                               | Call From                    |
|----------|--------------------------------------|------------------------------|
| Register | `RegisterEvent(event)`               | Client **(EventController)** |
